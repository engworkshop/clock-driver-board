...
This repository contains design files for a custom driver PCB for the [Mystery Clock](https://makerworld.com/en/models/764838) and [Hollow Clock 4 Remix](https://makerworld.com/en/models/875220) projects on [MakerWorld](https://makerworld.com/en/@EngWorkshop). This driver board incorporates 2 improvements: a dedicated real-time clock chip for greater timekeeping accuracy and a dedicated stepper motor driver module for silent operation.
...
- (4) M2 self-tapping pan head screws, 4 mm length, for mounting PCB (for example, [Amazon](https://www.amazon.com/gp/product/B07ZH9GJWP))
